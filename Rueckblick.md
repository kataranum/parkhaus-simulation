...
Zu Beginn haben wir die Aufgabenstellung gemeinsam mündlich besprochen, um ein einheitliches Verständnis zu bekommen. Anschließend haben wir die Aufgaben grob untereinander aufgeteilt. Danach haben wir die grundlegenden Funktionen definiert und auf Basis des Vorlesungswissens einen passenden Pseudocode erstellt. Währenddessen haben wir unsere Ansätze gegenseitig überprüft, mithilfe von GitHub und gemeinsamen Besprechungen, um Fehler frühzeitig zu erkennen. Außerdem haben wir darauf geachtet, dass die einzelnen Funktionen gut aufeinander abgestimmt sind.

### Teil 2

Im zweiten Teil haben wir den zuvor entwickelten Pseudocode schrittweise in C umgesetzt. Dabei lag ein Fokus auf der Fehlerbehebung, da beim Übertragen in Code immer wieder kleinere Probleme aufgetreten sind. Parallel dazu haben wir Unit-Tests geschrieben, um die Funktionen direkt überprüfen zu können. Zusätzlich wurde das CMake-System konfiguriert, um das Projekt korrekt zu bauen. Zum Abschluss haben wir letzte Fehler behoben, das Programm erfolgreich kompiliert und sowohl die Unit-Tests als auch abschließende Tests durchgeführt.
